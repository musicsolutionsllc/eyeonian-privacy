...
***Accounts, Purchases and Access.*** The web version uses Supabase (hosted on Amazon Web Services in the United States) to manage your account—including your email address—store your access status, and keep a record of your agreement to our Terms (the version you accepted and the date).
